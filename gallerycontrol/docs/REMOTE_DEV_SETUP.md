...
Run the gallerycontrol backend locally while communicating with devices at ZKM through an SSH tunnel.
...
poetry run uvicorn gallerycontrol.main:app --host 0.0.0.0 --port 8000 --reload
```

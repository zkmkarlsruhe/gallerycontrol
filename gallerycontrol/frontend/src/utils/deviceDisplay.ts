 ...
 * - NETIO hostname: "netio-009.example.com" -> "netio-009:1"
 * - ANEL hostname: "netzwerksteckdose21.example.com" -> "anel-21:1"
 * - IP addresses: "192.168.1.69" -> "1.69"
 * - Real names (e.g. "Projector A", "Main Hall"): name as-is
 */
export function formatDeviceDisplayName(device: Device): string {
  ...
  if (device_type === 'netio') {
    ...
    // Real name like "Main Projector" - just show as-is
    return name;
  }

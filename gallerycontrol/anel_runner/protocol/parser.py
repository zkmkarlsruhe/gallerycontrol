...
def parse_status_response(data: bytes | str) -> DeviceStatus | None:
    ...
    Example:
    NET-PwrCtrl:NET-CONTROL:192.168.1.100:255.255.255.0:192.168.1.1:0.1.2.3.4.5:Outlet 1,0:Outlet 2,0:Outlet 3,0:Outlet 4,0:Outlet 5,0:Outlet 6,0:Outlet 7,0:Outlet 8,0:248:80:NET-PWRCTRL_04.5:H:xo

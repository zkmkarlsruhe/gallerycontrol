# GalleryControl - Staff Guide

This guide covers how to use the GalleryControl interface to manage museum exhibition devices.
...
Open your web browser and navigate to the GalleryControl URL provided by your administrator (typically `http://your-server:8000`).

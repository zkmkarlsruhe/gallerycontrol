...
MuTech Control is a web-based system for controlling museum exhibition devices including projectors, power strips, and custom hardware. It provides:
...
cd mutech-control-service/frontend
npm install
npm run dev
```
...
For issues and feature requests, contact the ZKM technical team.
